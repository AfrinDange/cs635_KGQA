...
if __name__ =="__main__":
	...
	fb15kexp = build_data(name = 'imdb', path = tools.cur_path + '/datasets/')
	...
	all_params = { "Complex_Logistic_Model" : params } ; emb_size = 32 ; lmbda =0.01 ; params.neg_ratio=1 # negative samples were not added without that I got 0.5 MRR so remove this. 
	...
	scipy.io.savemat('embeddings/complex_embeddings.mat', \
